...
public class RaytraceUtil {
    ...
    private static ClipContext setupRayTraceContext(Player player, double distance, ClipContext.Fluid fluidHandling) {
        ...
        final float float_3 = Mth.cos(-yaw * 0.017453292F - 3.1415927F);
        final float float_4 = Mth.sin(-yaw * 0.017453292F - 3.1415927F);
        final float float_5 = -Mth.cos(-pitch * 0.017453292F);
